...
| 🤖 **Role 4 — AI & API** | **Simar** | [`Role_4_Simar_AI_and_API_Integration.pdf`](SatyaCheck_Roles_PDFs/Role_4_Simran_AI_and_API_Integration.pdf) | `artifacts/api-server/src/lib/ai-service.js` · `routes/chat.js` (AI logic) · `routes/analyze.js` (prompts) · `routes/quiz.js` · `routes/trending.js` · `routes/credibility.js` |
