...
import { Menu, X, Sun, Moon, ChevronDown, MessageCircle, Globe, Brain, TrendingUp, History, LogOut } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1.5">
            ...
            {/* Right actions: Theme + User Profile or CTA */}
            <div className="pl-3 ml-2 border-l border-border flex items-center gap-2">
              ...
              {user ? (
                ...
                <div className="relative" ref={profileRef}>
                  ...
                  {profileOpen && (
                    <div className="absolute top-full right-0 mt-1.5 w-56 bg-card border border-border rounded-lg shadow-lg p-2 z-50">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 text-xs text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-md transition-colors font-medium"
                      >
              ...
              <div className="mt-3 flex items-center justify-between bg-muted/50 rounded-lg px-3 py-2">
                <div className="flex items-center gap-2 min-w-0">
                  <img
                    src={user.photoURL}
                    alt={user.displayName}
                    className="w-7 h-7 rounded-full object-cover ring-2 ring-primary/30 shrink-0"
                    referrerPolicy="no-referrer"
                  />
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-[11px] text-red-500 hover:text-red-600 font-medium shrink-0 ml-2"
                >
                  <LogOut className="h-3.5 w-3.5" />
                  Sign out
                </button>
