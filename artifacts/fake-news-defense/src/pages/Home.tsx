    ...
    <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="flex flex-col gap-8">
              <motion.div
                ...
                className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-semibold w-fit border border-primary/20"
              >
      ...
      {stats && stats.total > 0 && (
        <motion.section
          ...
          className="py-6 border-y border-border/50 bg-muted/20 px-4"
        >
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            {[
              ...
              <div key={sdg.num} className="flex flex-col items-center gap-2">
                <img
                  src={`https://sdgs.un.org/sites/default/files/goals/E_SDG_Icons-${sdg.num}.jpg`}
                  alt={sdg.label}
                  className="h-16 w-16 rounded-xl shadow-md hover:scale-110 transition-transform duration-300 cursor-default"
                />
